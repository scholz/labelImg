...
from libs.utils import struct, newAction, newIcon, addActions, fmtShortcut, generateColorByText, randomizationValidator
...
class MainWindow(QMainWindow, WindowMixin):
    ...
    def __init__(self, defaultFilename=None, defaultPrefdefClassFile=None, defaultSaveDir=None):
        ...
        addActions(self.menus.file,
                   (open, opendir, refreshdir, copyPrevBounding, changeSavedir, openAnnotation, self.menus.recentFiles, save, save_format, saveAs, close, resetAll, deleteImg, quit))
